...
GAME_COMMANDS = [LookCommand(), EnterWorldCommand(), LeaveWorldCommand(), *build_direction_commands(), WorldCommand(), LEXICON_COMMAND, *TASK_COMMANDS]
__all__ = ['LookCommand', 'EnterWorldCommand', 'LeaveWorldCommand', 'WorldCommand', 'TaskCommand', 'GAME_COMMANDS']
