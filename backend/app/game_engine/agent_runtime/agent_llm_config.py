...
def apply_model_config_from_attributes(cfg: AgentLlmServiceConfig, node_attributes: Optional[Dict[str, Any]]) -> AgentLlmServiceConfig:
    """
...
def apply_prompt_overrides_from_attributes(cfg: AgentLlmServiceConfig, node_attributes: Optional[Dict[str, Any]]) -> AgentLlmServiceConfig:
    if not node_attributes:
        return cfg
...
def yaml_llm_base_from_by_service_id(service_id: str, model_config_ref: Optional[str]=None) -> AgentLlmServiceConfig:
    """
...
def merge_aico_system_llm_with_node(node_attributes: Optional[Dict[str, Any]]) -> AgentLlmServiceConfig:
...
def resolve_agent_llm_config_for_npc_tick(service_id: str, *, model_config_ref: Optional[str]=None, node_attributes: Optional[Dict[str, Any]]=None) -> AgentLlmServiceConfig:
    ...
    return resolve_agent_llm_config(service_id, model_config_ref=model_config_ref, node_attributes=node_attributes)

def resolve_agent_llm_config(service_id: str, *, model_config_ref: Optional[str]=None, node_attributes: Optional[Dict[str, Any]]=None) -> AgentLlmServiceConfig:
    """
