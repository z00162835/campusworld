...
def build_enrich_query_text(*, user_message: str, world_snapshot: str, stm_snippet: Optional[str], rule_hints: List[str], entity_spans: List[str], lexicon_hits: List[str]) -> str:
