...
def generate_item_located_in_relationships(*, data_root: Optional[Path]=None) -> List[Dict[str, Any]]:
    ...
    for row in items:
        ...
        out.append({'id': rel_id, 'rel_type_code': 'located_in', 'source_id': iid, 'target_id': rid, 'directed': True, 'attributes': {'source_kind': 'item'}})
    return out
...
def generate_npc_located_in_relationships(*, data_root: Optional[Path]=None) -> List[Dict[str, Any]]:
    ...
    for row in npcs:
        ...
        out.append({'id': rel_id, 'rel_type_code': 'located_in', 'source_id': nid, 'target_id': rid, 'directed': True, 'attributes': {'source_kind': 'npc'}})
    return out
