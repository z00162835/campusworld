...
def main() -> None:
    ...
    if args.val_jsonl:
        # Validation loop can call the same encoder + Trainer.evaluate; kept out of v1 CLI.
        pass
    ...
    for row in rows:
        ...
        feat = encode_chat_sft_example(
            tokenizer,
            system=ROUTER_SYSTEM_PROMPT,
            user=build_router_user_content(row),
            assistant_text=assistant,
            max_seq_len=args.max_seq_len,
            completion_reserved=args.completion_tokens,
        )
    ...
    meta = {
        ...
        "schema": "tool_router_train_row.schema.json",
        "assistant_format": '{"tool_names": [...]}',
        "n_rows": len(rows),
