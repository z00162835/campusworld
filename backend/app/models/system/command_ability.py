    ...
    def __init__(
        ...
        **kwargs,
        ...
        attrs = {
            ...
            "entity_kind": kwargs.pop("entity_kind", "ability"),
            "presentation_domains": list(kwargs.pop("presentation_domains", ["help", "npc"])),
            "access_locks": kwargs.pop("access_locks", {"view": "all()", "invoke": "all()"}),
