...
def run_schema_migrations(engine) -> List[MigrationStepResult]:
    from db.schema_migrations import (
        ...
        ensure_command_ability_envelope_refresh,
    ...
    steps: List[tuple[str, Callable]] = [
        ...
        ("ensure_multi_turn_conversation_memory_schema", ensure_multi_turn_conversation_memory_schema),
        ...
        ("ensure_command_ability_envelope_refresh", ensure_command_ability_envelope_refresh),
