...
class Building(DefaultObject):
    ...
    def __init__(self, name: str, config: Dict[str, Any] = None, **kwargs):
        ...
        default_attrs = {
            ...
            "building_code": "campuscode_bldcode", # 园区代码_建筑代码, 如：RES001_BLD001, 作为索引标识
            "building_name": "示例教学楼",
...
class BuildingFloor(DefaultObject):
    ...
    def get_floor_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'functions': self._node_attributes.get('floor_functions', []),
            'is_accessible': self._node_attributes.get('floor_accessibility', True),
            'is_public': self._node_attributes.get('floor_is_public', True)
        }
